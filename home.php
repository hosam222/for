  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="pay.php"><span class="glyphicon glyphicon-usd"></span>  Pay</a></li>
...
<div class="banner">
    ...
    <center>
        ...
        $Shipment=$_POST["Shipment"];
         ...
         if($fcountry=='Khartoum'&& $tcountry=='Gedaref')
 $price= $price-100;
      if($fcountry=='Khartoum'&& $tcountry=='Al Jazeera')
$price= $price-200;
      if($fcountry=='Khartoum'&& $tcountry=='Blue Nile')
$price= $price-300;
      if($fcountry=='Khartoum'&& $tcountry=='East Darfur State')
$price= $price-400;

 if($fcountry=='Gedaref'&& $tcountry=='East Darfur State')
 $price= $price-200;
      if($fcountry=='Gedaref'&& $tcountry=='Al Jazeera')
$price= $price-400;
      if($fcountry=='Gedaref'&& $tcountry=='Blue Nile')
$price= $price-500;
      
       if($fcountry=='Al Jazeera'&& $tcountry=='East Darfur State')
 $price= $price-600;
      if($fcountry=='Al Jazeera'&& $tcountry=='Blue Nile')
$price= $price-700;
